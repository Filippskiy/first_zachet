...
function name($a,$b){ // функция, определяющая способ сортировки (по названию столицы)
  ...
  function price($a,$b){ // функция, определяющая способ сортировки (по населению)
    if ($a["price"] < $b["price"]) return -1;
    elseif ($a["price"]==$b["price"]) return 0;
    else return 1;
   }
   function year($a,$b){ // функция, определяющая способ сортировки (по населению)
    if ($a["year"] < $b["year"]) return -1;
    elseif ($a["year"]==$b["year"]) return 0;
    else return 1;

   }
   function genre($a,$b){ // функция, определяющая способ сортировки (по названию столицы)
    if ($a["genre"] < $b["genre"]) return -1;
    elseif ($a["genre"]==$b["genre"]) return 0;
    else return 1;
   }
   function sorting($p){
    global $books;
